...
function Home() {
  ...
  useEffect(() => {
    socket.on("ai-response", (payload) => {
      ...
      const aiMsg = {
        chatId: activeChat,
        role: "assistant", // standardized to match UI
        sender: "AI",
        ...
        <div className="space-y-6 max-w-4xl mx-auto">
          ...
          {isLoading && (
            <div className="flex items-start gap-3 justify-start">
              <div className="w-8 h-8 bg-gradient-to-br from-indigo-500 to-purple-600 rounded-full flex items-center justify-center flex-shrink-0 animate-spin">
                <Bot className="w-4 h-4 text-white" />
              </div>
